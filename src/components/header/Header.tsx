        ...
        <div className="w-full h-full header-color header-text-color flex-between">
            <div className="w-fit h-full flex items-center gap-8 max-w-[60%]">
                ...
                <button className="w-20 h-full bg-dark-gray flex-center hover:bg-orange" onClick={() => toggleSidebar()}>
                    <svg className="fill-white" width="30" height="18" xmlns="http://www.w3.org/2000/svg">
                        <g fillRule="evenodd"><path d="M0 0h30v2H0zM0 8h30v2H0zM0 16h30v2H0z" /></g>
                    </svg>
                </button>
                ...
                <div className="flex-center gap-4">
                    <svg width="14" height="16" xmlns="http://www.w3.org/2000/svg" className='w-full max-w-fit'>
                    ...
                    <div className="flex flex-col">
                        <p className="body-medium text-light-gray-3 mobile:hidden">Document Name</p>
                        <input type="text"
                            value={docName}
                            onChange={handleDocChange}
                            className="outline-none heading-medium header-color header-text-color focus:underline caret-orange p-1 w-full"
                        />
            ...
            <div className="flex items-center gap-8 mobile:gap-4 p-2 mr-2">
                    ...
                    <div className="flex">
                        <Tooltip description="Download file">
                            <button className="btn" onClick={handleFileDownload}>
                                <svg className={`fill-light-gray-3 ${docs.length != 0 ? 'hover:fill-orange' : ""}`} xmlns="http://www.w3.org/2000/svg" width="18" height="20" viewBox="0 0 24 24">
                ...
                >
                    ...
                    <span className="mobile:hidden heading-medium">Save Changes</span>
                </button>
            </div>
        </div>
