    ...
    return (
        <div className="w-full h-full header-color header-text-color flex-between">
            <div className="w-fit h-full flex items-center gap-8">
                ...
                <button className="w-20 h-full bg-dark-gray flex-center" onClick={() => toggleSidebar()}>
                    <svg className="fill-white hover:fill-orange" width="30" height="18" xmlns="http://www.w3.org/2000/svg">
