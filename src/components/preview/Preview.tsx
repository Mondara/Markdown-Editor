...
export const Preview: React.FC<Props> = ({ data, showEditor, toggleEditor }) => {
  return (
    <div className={`${showEditor ? "w-6/12" : "w-full"} preview-color h-full flex flex-col overflow-y-auto ${showEditor ? "mobile:hidden" : "mobile:block"}`}>
      <div className="w-full p-4 flex-between preview-header-color">
        <h5 className="heading-small preview-header-text-color">PREVIEW</h5>
        <button onClick={toggleEditor}>
          {showEditor ?
            // icon-show-preview.svg
            (<svg width="16" height="12" xmlns="http://www.w3.org/2000/svg" className="fill-light-gray-3 hover:fill-orange">
            ...
            :
            // icon-hide-preview.svg
            (<svg width="16" height="15" xmlns="http://www.w3.org/2000/svg" className=" fill-light-gray-3 hover:fill-orange">
      ...
      <div className="w-full h-full px-4 py-2 preview preview-text-color">
