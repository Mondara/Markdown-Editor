...
export const Preview: React.FC<Props> = ({ data, showEditor, toggleEditor }) => {
  return (
    <div className={`${showEditor ? "w-6/12" : "w-full"} preview-color h-full flex flex-col overflow-y-auto`}>
      <div className="w-full px-4 py-2 flex-between preview-header-color">
        <h5 className="preview-header-text-color">PREVIEW</h5>
