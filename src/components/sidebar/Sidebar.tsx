    ...
    return (
        <div className="bg-dark-gray-3 w-full h-full flex flex-col justify-between p-6">
            <div className="flex flex-col gap-8">
                ...
                <p className='text-light-gray-3 heading-small'>MY DOCUMENT</p>

                <button
                    className="heading-medium flex items-center gap-2 bg-orange p-4 rounded text-white hover:bg-orange-light"
                    onClick={() => openModal()}
                >
                    <span>+</span>
                    New Document
                    ...
                    {docs.map((doc, idx) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col items-start justify-start">
                                <p className="body-medium text-light-gray-3 hover:text-orange">{doc.createdAt}</p>
                                <p className="heading-medium text-white text-start hover:text-orange">{doc.name}</p>
                            </div>
                        </button>
                    ))}
                </div>
            ...
            <div className='flex gap-4 items-center'>
                <svg className={theme === 'dark' ? "fill-white" : "fill-light-gray-4"} width="17" height="16" xmlns="http://www.w3.org/2000/svg">
